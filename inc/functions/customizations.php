...
if( function_exists('acf_add_options_sub_page') )
{
    acf_add_options_sub_page(array(
        'title' => __( 'Site Options', 'gildersleeve' ),
...
//function gildersleeve_mce_buttons_2($buttons) {	
//	/**
...
//	return $buttons;
//}
//add_filter('mce_buttons_2', 'gildersleeve_mce_buttons_2');


// Remove all colors except those custom colors specified from TinyMCE
//function gildersleeve_change_mce_options( $init ) {
//	$custom_colors = '"#####1", "Color Name 1", "#####2", "Color Name 2", "#####3", "Color Name 3"';	
//	$init['textcolor_map'] = '['.$custom_colors.']';
//return $init;
//}
//add_filter('tiny_mce_before_init', 'gildersleeve_change_mce_options');


// Modify the query on a given template (using conditionals)
//function gildersleeve_custom_query($query) {
//    if ($query->is_search) {
//        $query->set('post_type', 'post');
//    }
//    return $query;
//}
//add_filter('pre_get_posts','gildersleeve_custom_query');
?>